...
if [ "$distro" == "ubuntu" ]; then
  ...
  if [ "$user" == "amd" ]; then
	  ...
	  cp /usr/automation-logs/state-files/kernel-version /usr/automation-logs/state-files/patch-kernel-version || handle_error "couldn't copy the installed kernel version to the state_file"
...
#	  echo KERNEL_VERSION >
	  ...
	  cp /usr/automation-logs/state-files/kernel-version /usr/automation-logs/state-files/base-kernel-version || handle_error "couldn't copy the installed kernel version to the state_file"
